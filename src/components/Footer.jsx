...
const Footer=()=>{
    ...
    return (
        <section >
        <footer style={{ paddingTop:"80px" }} class="bg-white dark:bg-gray-900">
    <div  class="container p-6 mx-auto">
        <div style={{ marginBottom:"15px" }} class="lg:flex justify-center items-center">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    <a href="#">
                        <img class="w-60" src={logoWhite} alt=""/>
                    </a>
        ...
        <div>
            <p class="text-center text-gray-500 dark:text-gray-400">© Etudigique 2024 - All rights reserved</p>
        </div>
    </div>
</footer>
        </section>
