...
const Footer=()=>{
    ...
    return (
        <section >
        <footer style={{ paddingTop:"80px" }} className="bg-white dark:bg-gray-900">
    <div  className="container p-6 mx-auto">
        <div style={{ marginBottom:"15px" }} className="lg:flex justify-center items-center">
            <div className="w-full -mx-6 lg:w-2/5">
                <div className="px-6">
                    <a href="#">
                        <img className="w-60" src={logoWhite} alt=""/>
                    </a>
        ...
        <div>
            <p className="text-center text-gray-500 dark:text-gray-400">© Etudigique 2024 - All rights reserved</p>
        </div>
    </div>
</footer>
        </section>
