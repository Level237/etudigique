    ...
    return (
        ...
        <React.Fragment >
            ...
            <div className="mt-[12px] ml-10 text-white font-bold text-xl flex flex-col">
                ...
                <Link to="equivalence-de-diplome" title="Equivalence de Diplome" className="block py-1 px-2 text-[#ffcc00]">Equivalence de diplome</Link>
                </div>
                <div onClick={()=>closeHeader()}   className="text-sm mt-1 py-1 px-2 text-[#ffcc00]">
                <Link to="admission" className="block py-1 px-2">Admission</Link>
                </div>
                <div onClick={()=>closeHeader()}  className=" text-sm mt-1 py-1 px-2 text-[#ffcc00]">
                <Link to="campus-belgique" className="block py-1 px-2">Campus belgique</Link>
                </div>
                <div onClick={()=>closeHeader()} className=" text-sm mt-1 py-1 px-2 text-[#ffcc00]">
                <Link to="demande-visa" className="block py-1 px-2">Demande de Visa</Link>
                </div>
                <div onClick={()=>closeHeader()} className="mt-5">
                <Link to='a-propos-de-nous'
                className=' text-white block'>A Propos de nous</Link>
                </div>
                <div onClick={()=>closeHeader()} className="mt-5">
                Contactez nous
                </div>
