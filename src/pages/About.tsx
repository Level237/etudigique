...
<meta property="og:title" content="Etudigique:Réalisez votre projet d'étude en Belgique" />
  ...
  <meta property="og:type" content="website" />
        ...
        <Circle width="470px" height="470px" bgColor="#ffcc00" opacity="0.2" top="200px" left="-150px" right={""}/>
       ...
       <div className="flex flex-col flex-1 ml-32 max-sm:ml-5">
        ...
        <Circle width="590px" height="590px" bgColor="#ffcc00" opacity="0.2" top="820px" right="-190px" left={""}/>
          <div className="mt-7">
            <Button  title="En savoir plus" color="white" type="secondary" link={""}/>
          </div>
        ...
        <p className="mt-7">Chez Etudigique, nous nous engageons à vous accompagner à chaque étape de votre aventure académique en Belgique. Notre équipe dévouée d’avocats et de consultants en immigration expérimentés est là pour vous guider dans toutes les phases du processus, de la demande de visa à la recherche de la formation idéale en Belgique.</p>
          <div className="mt-7">
            <Button  title="Contactez nous" color="white" type="secondary" link={""}/>
          </div>
       ...
       <img className="w-full rounded-[10%]" src={img3}/>
        ...
        <div className="flex max-sm:flex-col">
          ...
          <h2 className="my-8 text-2xl max-sm:text-xl max-sm:text-center font-bold text-center  text-white md:text-4xl">
