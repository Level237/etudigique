...
const  Contact=()=> {
  return (
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        ...
        <div>
            <label for="company" class="block mb-2 text-sm font-medium text-gray-90">Pays</label>
    ...
    <option value="Autres">Autres</option>
        ...
        <div>
            <label for="company" class="block mb-2 text-sm font-medium text-gray-90">Services</label>
            <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <option value="Demande de Visa">Demande de visa</option>
        ...
        <div>
            <label for="phone" class="block mb-2 text-sm font-medium text-gray-90">Numéro de Téléphone</label>
            <input type="tel" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="123-45-678" required />
        </div>
         <div>
         <label for="message" class="block mb-2 text-sm font-medium text-gray-900 ">Votre message</label>
<textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:placeholder-gray-400"></textarea>
         </div>
    ...
    <button type="submit" class="text-black  bg-[#ffcc33] hover:bg-[#cc3333] hover:text-white  focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center  ">Envoyer</button>
    </div>
