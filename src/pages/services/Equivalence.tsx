...
const Equivalence=(props)=>{
  ...
  useEffect(()=>{
    ...
    return (
      ...
      <p className=" text-gray-600 md:w-2/3 max-sm:mt-5 lg:w-3/7 max-sm:text-center">Obtenir l'équivalence de votre diplôme est une étape indispensable pour poursuivre vos études en Belgique. Cette procédure peut s'avérer complexe et fastidieuse, mais Etudigigue est là pour vous simplifier la vie !</p>
    </div>
    ...
    <div className='mt-5 flex items-center justify-center'>
      ...
      <div className="grid grid-cols-2 max-sm:grid-cols-1 space-y-4 divide-gray-100 dark:divide-gray-800">
            <div className="mt-8 flex gap-4 md:items-center">
              ...
              <div className="w-5/6">
                <h3 className="font-semibold text-lg  text-[#ffcc33]">Collecte des documents nécessaires</h3>
                <p className="text-white">Nous vous guidons dans la recherche et la traduction des documents requis pour votre demande d'équivalence.</p>
              </div> 
            </div> 
            <div className="pt-4 flex gap-4 md:items-center">
              ...
              <div className="w-5/6">
                <h3 className="font-semibold text-lg text-[#ffcc33]">Remplissage du formulaire de demande</h3>
                <p className="text-white">Nous vous assistons dans la complétion du formulaire et veillons à ce qu'il soit correctement rempli.</p>
              </div> 
            </div> 
            <div className="pt-4 flex gap-4 md:items-center">
              <div className="w-12 h-12 flex gap-4 rounded-full bg-[#ffcc3321]">  
              ...
              <div className="w-5/6">
                <h3 className="font-semibold text-lg text-[#ffcc33]">Dépôt de la demande</h3>
                <p className="text-white">Nous nous chargeons de déposer votre demande auprès des autorités compétentes et de suivre son avancement.</p>
              </div> 
            </div> 
            <div className="pt-4 flex gap-4 md:items-center">
              <div className="w-12 h-12 flex gap-4 rounded-full bg-[#ffcc3321]">  
              ...
              <div className="w-5/6">
                <h3 className="font-semibold text-lg text-[#ffcc33]">Obtention de l'équivalence</h3>
                <p className="text-white">Nous vous informons de la décision des autorités et vous assistons dans les démarches ultérieures.</p>
              </div> 
            </div>
          </div>
          </div>
  ...
  autoplay={{ 
    ...
    disableOnInteraction:false
      ...
      <div   className=" p-3 relative rounded-3xl   bg-[#ffcc33] transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
      ...
      <div
       ...
       className="group relative  rounded-3xl  bg-[#ffcc33] transition hover:z-[1] hover:shadow-2xl">
        <div className="relative space-y-8 py-12 p-8">
      ...
      <div 
      className="group relative rounded-3xl  bg-[#ffcc33] transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
