    ...
    <div className='mt-5 flex items-center justify-center'>
      ...
      <div className="grid grid-cols-2 max-sm:grid-cols-1 space-y-4 divide-gray-100 dark:divide-gray-800">
            <div className="mt-8 flex gap-4 md:items-center">
              ...
              <div className="w-5/6">
                <h3 className="font-semibold text-lg  text-[#ffcc33]">Évaluation de votre éligibilité au programme</h3>
                <p className="text-white">Analyse de votre situation académique et de vos qualifications.
...
Conseils personnalisés pour maximiser vos chances d'admission.</p>
            ...
            <div className="pt-4 flex gap-4 md:items-center">
              ...
              <div className="w-5/6">
                <h3 className="font-semibold text-lg text-[#ffcc33]">Aide à la constitution de votre dossier de candidature</h3>
                <p className="text-white">Assistance dans la recherche et la collecte des documents requis.
...
Traduction des documents nécessaires, si besoin.</p>
            ...
            <div className="pt-4 flex gap-4 md:items-center">
              ...
              <div className="w-5/6">
                <h3 className="font-semibold text-lg text-[#ffcc33]">Conseils personnalisés pour le choix de votre université</h3>
                <p className="text-white">Présentation des différentes universités et programmes d'études disponibles en Belgique.
            ...
            <div className="pt-4 flex gap-4 md:items-center">
              ...
              <div className="w-5/6">
                <h3 className="font-semibold text-lg text-[#ffcc33]">Aide à l'obtention du visa d'études</h3>
  ...
  autoplay={{ 
    ...
    disableOnInteraction:false
       ...
       paddingBottom:"120px",
        ...
        <div className="mt-16 grid   divide-x gap-4 div divide-gray-100   overflow-hidden  text-gray-600 dark:border-gray-700 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-3">
